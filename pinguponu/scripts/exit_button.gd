...
func _ready() -> void:
	...
	hover_material.emmision_energy_multiplier = 0.0
...
func _on_mouse_entered():
	...
	tween.tween_property(hover_material, "emmision_energy_multiplier", 2.0, 0.15)

func _on_mouse_exited():
	var tween = create_tween().set_parallel(true)
	tween.tween_property(self, "scale", Vector3(1, 1, 1), 0.15)
	tween.tween_property(hover_material, "emission_energy_mutiplier", 0.0, 0.15)
